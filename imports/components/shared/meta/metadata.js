export default function generateData(newData) {
  const defaultData = {
    ...
    description:
      "NewSpring Church exists to reach people far from God and teach them how to follow Jesus step by step. We currently have 16 campuses across the state of South Carolina.",
