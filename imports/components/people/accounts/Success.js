...
const Success = ({ person, onExit }) =>
  <div className="soft soft-double-ends one-whole text-center">
    ...
    <p className="text-left">
      Congratulations on setting up your NewSpring account! This account will
      help us to serve you better in your walk with Jesus. To help us make sure
      the information we have is accurate and up to date, we would love if you
      could complete your profile.
    </p>
