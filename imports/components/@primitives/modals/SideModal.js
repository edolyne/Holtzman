...
export default class SideModal extends Component {
  ...
  render() {
    ...
    return (
      <div className="panel overlay--solid-dark fixed" data-side-modal id="@@modal" onClick={close} tabIndex="0" role="dialog" onKeyDown={close} style={this.getContainerStyle()}>
        <VelocityComponent
          animation={slide}
          duration={300}
          runOnMount
