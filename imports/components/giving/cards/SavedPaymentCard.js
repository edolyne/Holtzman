...
const SavedPaymentCard = ({ payment, onClick, classes }: ISavedPaymentCard) =>
  <div
    className={`${classes || ""}`}
    onClick={onClick}
      ...
      >
        <div className="floating grid">
          <div className="floating__item grid__item two-thirds text-left">
            <h5 className="text-dark-primary capitalize push-half-bottom">
              {payment.name}
            </h5>
            <div className="floating text-left">
              <h6 className="text-dark-tertiary flush soft-half-right floating__item">
