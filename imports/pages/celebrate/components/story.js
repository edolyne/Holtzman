...
const Story = ({
  ...
  <div className="grid soft-double-bottom soft-double-top@lap-and-up">
    <div className="constrain-page">
      {image &&
        <div
          className="grid__item@lap-and-up one-third@lap-and-up display-inline-block soft-right@lap-and-up push-bottom@lap-and-up"
      ...
      <div
        className={`grid__item ${image &&
          "two-thirds@lap-and-up"} floating text-center text-left@lap-and-up display-inline-block`}
        style={{ verticalAlign: "middle" }}
      >
        {overriddenHeader &&
          <h5
