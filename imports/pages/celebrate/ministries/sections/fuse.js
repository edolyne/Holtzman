  ...
  <div>
    ...
    <div className="background--light-primary text-center soft-double-ends">
      <div className="constrain-copy soft-double-ends soft-sides@handheld push-double-ends">
        <div className="one-whole">
          <h3 className="italic push-half-bottom" style={{ color: "#4F92A9" }}>
          ...
          <h3 className="soft-bottom" style={{ color: "#4F92A9" }}>
            students meet Jesus at Fuse.
          </h3>
        </div>
      </div>
    </div>
    ...
    <div
      className="soft-double-ends@lap-and-up soft-ends text-center text-light-primary"
      style={{ backgroundColor: "#4F92A9" }}
    >
