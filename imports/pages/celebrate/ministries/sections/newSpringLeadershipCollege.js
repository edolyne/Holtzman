...
const data = {
  tags: {
    ...
    tags: [
      {
        image1x1:
          "//s3.amazonaws.com/ns.assets/apollos/annual+report/2016/tags/college/tag1_1x1.jpg",
        image2x1:
          "//s3.amazonaws.com/ns.assets/apollos/annual+report/2016/tags/college/tag1_2x1.jpg",
      ...
      {
        image1x1:
          "//s3.amazonaws.com/ns.assets/apollos/annual+report/2016/tags/college/tag2_1x1.jpg",
        image2x1:
          "//s3.amazonaws.com/ns.assets/apollos/annual+report/2016/tags/college/tag2_2x1.jpg",
      ...
      {
        image1x1:
          "//s3.amazonaws.com/ns.assets/apollos/annual+report/2016/tags/college/tag3_1x1.jpg",
        image2x1:
          "//s3.amazonaws.com/ns.assets/apollos/annual+report/2016/tags/college/tag3_2x1.jpg",
        ...
        <div className="grid__item one-whole text-center soft-bottom@lap-and-up">
          <div className="constrain-copy">
            <h3 className="italic text-primary">
              <strong>
                NewSpring Leadership College is raising leaders for the local
                church.
              </strong>
            </h3>
          </div>
