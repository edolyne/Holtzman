...
const data = {
  ...
  stories: [
    {
      imageUrl:
        "//s3.amazonaws.com/ns.assets/apollos/annual%20report/2016/stories/story-img7.1.png",
      name: "Liz Wynn",
      location: "Arkansas",
      heading: "Hear from childrens ministry director",
      content:
        "<p>&#34;We've been using NewSpring's free children's curriculum exclusively since the beginning of 2016, and the kids love it, especially the acting and the games! Our kids leave excited to tell their friends about church and want to come back every week.&#34;</p>",
    },
  ],
};
        ...
        <div className="grid__item one-whole">
          <div className="constrain-copy">
            ...
            <p className="text-left">
              ...
              opportunities, and
              leadership training. Through NewSpring Network, our church
              provides free
              children&#39;s ministry curriculum, series graphics, and videos,
              chord charts, and
              volunteer training.
            </p>
          </div>
