...
const data = {
  statistics: {
    icons: [
      {
        image:
          "//s3.amazonaws.com/ns.assets/apollos/annual%20report/2016/icons/icon-fish.png",
        label: "pounds of Goldfish given out by KidSpring",
        value: "25,000+",
      },
      {
        image:
          "//s3.amazonaws.com/ns.assets/apollos/annual%20report/2016/icons/icon-car.png",
        label: "cars parked by volunteers",
        value: "700,000+",
      },
      {
        image:
          "//s3.amazonaws.com/ns.assets/apollos/annual%20report/2016/icons/icon-mail.png",
        label: "emails received to hello@newspring.cc",
        value: "4,000+",
      },
      {
        image:
          "//s3.amazonaws.com/ns.assets/apollos/annual%20report/2016/icons/icon-mug.png",
        label: "pounds of coffee brewed by volunteers",
        value: "4,900+",
      },
      {
        image:
          "//s3.amazonaws.com/ns.assets/apollos/annual%20report/2016/icons/icon-pencil.png",
        label: "pens given away",
        value: "220,000+",
      },
      {
        image:
          "//s3.amazonaws.com/ns.assets/apollos/annual%20report/2016/icons/icon-baby.png",
