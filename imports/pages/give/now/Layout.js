    ...
    >
      <div className="text-left soft-top@anchored hard-left@lap-and-up soft-half-bottom soft@anchored ">
        <div className="soft-double-ends@palm-wide-and-up soft-ends@palm">
          ...
          {alive &&
            !accounts.loading &&
            <AddToCart accounts={accounts.accounts} />}
        </div>
      </div>
    </div>
      ...
      <div className="grid">
        ...
        {accounts.accounts &&
          accounts.accounts.map((account, i) =>
            <div
              key={i}
              className="grid__item one-whole push-half-bottom flush-bottom@handheld hard-bottom"
            >
              <SideBySide
                  ...
                  if (process.env.NATIVE) {
                    return (
                      ...
                      >
                        ...
                        >
                          <i
                            className="soft-half-right icon-category-text text-dark-tertiary"
                            style={{ verticalAlign: "middle" }}
                          />
                          <h7
