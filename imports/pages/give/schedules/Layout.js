...
export default class Layout extends Component {
  ...
  formatDate = date => moment(date).add(1, "day").format("MMM D, YYYY");
  ...
  render() {
    ...
    const photo =
      "//s3.amazonaws.com/ns.assets/apollos/give_now-schedules1x2.jpg";
                ...
                <div>
                  {schedules &&
                    schedules.map((schedule, i) => {
                      ...
                      if (
                        moment(schedule.next).add(1, "day") <
                          moment().add(1, "day") &&
                  ...
                  <p className="soft text-center">
                    <small>
                      <em>
                        Changes to schedules may take a few minutes to be
                        reflected here.
                      </em>
                    </small>
                  </p>
