...
export default ({
  ...
  <div>
    ...
    <Filter family={family} filterTransactions={filterTransactions} />
    <div
      className={
    ...
    >
      ...
      {process.env.WEB &&
        ...
        >
          ...
          {printLoading &&
            <div
              style={{ position: "absolute", right: "14px", marginTop: "13px" }}
            >
              <Spinner
                styles={{ width: "30px", height: "30px", borderWidth: "3px" }}
              />
            </div>}
        </div>}
      ...
      {!transactions.length &&
        ...
        <div className="text-left soft-ends soft-half-sides">
          <p>
            ...
            If you would like to start giving, click{" "}
            <Link to="/give/now">here</Link>
          </p>
          <p>
            <em>
